...
export default function CreateRoomModal({
  ...
  const [pricePerPeriod, setPricePerPeriod] = useState("");
  const [equipment, setEquipment] = useState<string[]>([]);
  const [periodMorning, setPeriodMorning] = useState(false);
  const [periodAfternoon, setPeriodAfternoon] = useState(false);
  const [periodEvening, setPeriodEvening] = useState(false);
      ...
      >
        ...
        >
          <div className="flex items-center justify-between p-6 border-b border-neutral-100">
            <h2 className="font-display font-bold text-lg text-neutral-800">Nova Sala</h2>
            <button
              onClick={onClose}
